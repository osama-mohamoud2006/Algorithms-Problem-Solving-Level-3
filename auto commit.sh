...
project_dir="E:/projects/c++ course/07 - Algorithms & Problem Solving Level 3"
cd "$project_dir" || exit
...
git remote add origin "https://github.com/osama-mohamoud2006/Algorithms-Problem-Solving-Level-3.git"
